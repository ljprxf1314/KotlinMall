...
class BottomNavBar @JvmOverloads constructor(
    ...
    init {
        ...
        val homeItem = BottomNavigationItem(R.drawable.btn_nav_home_press,resources.getString(R.string.nav_bar_home))
                .setInactiveIconResource(R.drawable.btn_nav_home_normal) //未选中状态
                .setActiveColorResource(R.color.common_blue)  //选中颜色
                .setInActiveColorResource(R.color.text_normal) //默认颜色
        ...
        //设置底部导航模式及样式
        setMode(BottomNavigationBar.MODE_FIXED)  //固定在底部
